...
#%%
# Plot of the test set error as a function of the size of the forest.
...
# The plot above has the same characteristics as that of random forests.
# In general:

# If you apply subsampling, you need to lower the learning rate.
# Decreasing the learning rate requires more trees.
# As with gradient descent, at some point, additional iterations result in 
# negligible model improvement as the algorithm has converged.
